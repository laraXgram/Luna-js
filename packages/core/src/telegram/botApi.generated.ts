...
// Bot API version: 10.0
// Scraped at: 2026-06-09T23:04:16+00:00
// Regenerate: node scripts/generate-bot-api-types.mjs

export const BOT_API_VERSION = '10.0'
...
export interface MaybeInaccessibleMessage {
  __union__: Message | InaccessibleMessage
}
...
export interface MessageOrigin {
  __union__: MessageOriginUser | MessageOriginHiddenUser | MessageOriginChat | MessageOriginChannel
}
...
export interface PaidMedia {
  __union__: PaidMediaLivePhoto | PaidMediaPhoto | PaidMediaPreview | PaidMediaVideo
}
...
export interface InputPollMedia {
  __union__: InputMediaAnimation | InputMediaAudio | InputMediaDocument | InputMediaLivePhoto | InputMediaLocation | InputMediaPhoto | InputMediaVenue | InputMediaVideo
}

/** This object represents the content of a poll option to be sent. It should be one of */
export interface InputPollOptionMedia {
  __union__: InputMediaAnimation | InputMediaLivePhoto | InputMediaLocation | InputMediaPhoto | InputMediaSticker | InputMediaVenue | InputMediaVideo
}
...
export interface BackgroundFill {
  __union__: BackgroundFillSolid | BackgroundFillGradient | BackgroundFillFreeformGradient
}
...
export interface BackgroundType {
  __union__: BackgroundTypeFill | BackgroundTypeWallpaper | BackgroundTypePattern | BackgroundTypeChatTheme
}
...
export interface ChatMember {
  __union__: ChatMemberOwner | ChatMemberAdministrator | ChatMemberMember | ChatMemberRestricted | ChatMemberLeft | ChatMemberBanned
}
...
export interface StoryAreaType {
  __union__: StoryAreaTypeLocation | StoryAreaTypeSuggestedReaction | StoryAreaTypeLink | StoryAreaTypeWeather | StoryAreaTypeUniqueGift
}
...
export interface ReactionType {
  __union__: ReactionTypeEmoji | ReactionTypeCustomEmoji | ReactionTypePaid
}
...
export interface OwnedGift {
  __union__: OwnedGiftRegular | OwnedGiftUnique
}
...
export interface BotCommandScope {
  __union__: BotCommandScopeDefault | BotCommandScopeAllPrivateChats | BotCommandScopeAllGroupChats | BotCommandScopeAllChatAdministrators | BotCommandScopeChat | BotCommandScopeChatAdministrators | BotCommandScopeChatMember
}
...
export interface MenuButton {
  __union__: MenuButtonCommands | MenuButtonWebApp | MenuButtonDefault
}
...
export interface ChatBoostSource {
  __union__: ChatBoostSourcePremium | ChatBoostSourceGiftCode | ChatBoostSourceGiveaway
}
...
export interface InputMedia {
  __union__: InputMediaAnimation | InputMediaAudio | InputMediaDocument | InputMediaLivePhoto | InputMediaPhoto | InputMediaVideo
}
...
export interface InputPaidMedia {
  __union__: InputPaidMediaLivePhoto | InputPaidMediaPhoto | InputPaidMediaVideo
}
...
export interface InputProfilePhoto {
  __union__: InputProfilePhotoStatic | InputProfilePhotoAnimated
}
...
export interface InputStoryContent {
  __union__: InputStoryContentPhoto | InputStoryContentVideo
}
...
export interface InputMessageContent {
  __union__: InputTextMessageContent | InputLocationMessageContent | InputVenueMessageContent | InputContactMessageContent | InputInvoiceMessageContent
}
...
export interface RevenueWithdrawalState {
  __union__: RevenueWithdrawalStatePending | RevenueWithdrawalStateSucceeded | RevenueWithdrawalStateFailed
}
...
export interface TransactionPartner {
  __union__: TransactionPartnerUser | TransactionPartnerChat | TransactionPartnerAffiliateProgram | TransactionPartnerFragment | TransactionPartnerTelegramAds | TransactionPartnerTelegramApi | TransactionPartnerOther
}
...
export interface PassportElementError {
  __union__: PassportElementErrorDataField | PassportElementErrorFrontSide | PassportElementErrorReverseSide | PassportElementErrorSelfie | PassportElementErrorFile | PassportElementErrorFiles | PassportElementErrorTranslationFile | PassportElementErrorTranslationFiles | PassportElementErrorUnspecified
}
...
/** Parameters for the `getWebhookInfo` method. */
...
/** Parameters for the `sendLivePhoto` method. */
...
/** Parameters for the `getUserProfileAudios` method. */
...
/** Parameters for the `setChatMemberTag` method. */
...
/** Parameters for the `getUserPersonalChatMessages` method. */
...
/** Parameters for the `answerGuestQuery` method. */
...
/** Parameters for the `setManagedBotAccessSettings` method. */
...
/** Parameters for the `setMyProfilePhoto` method. */
export interface SetMyProfilePhotoParams {
  /** The new profile photo to set */
  photo: InputProfilePhoto
}

/** Parameters for the `removeMyProfilePhoto` method. */
...
/** Parameters for the `removeBusinessAccountProfilePhoto` method. */
...
/** Parameters for the `getBusinessAccountStarBalance` method. */
...
/** Parameters for the `getBusinessAccountGifts` method. */
...
/** Parameters for the `savePreparedKeyboardButton` method. */
...
/** Parameters for the `deleteMessageReaction` method. */
...
/** Parameters for the `deleteAllMessageReactions` method. */
...
/** Parameters for the `getMyStarBalance` method. */
...
export interface BotApiMethods {
  ...
  getWebhookInfo: GetWebhookInfoParams
  getMe: GetMeParams
  logOut: LogOutParams
  close: CloseParams
  ...
  copyMessage: CopyMessageParams
  copyMessages: CopyMessagesParams
  sendPhoto: SendPhotoParams
  sendLivePhoto: SendLivePhotoParams
  sendAudio: SendAudioParams
  sendDocument: SendDocumentParams
  sendVideo: SendVideoParams
  sendAnimation: SendAnimationParams
  sendVoice: SendVoiceParams
  sendVideoNote: SendVideoNoteParams
  sendPaidMedia: SendPaidMediaParams
  sendMediaGroup: SendMediaGroupParams
  sendLocation: SendLocationParams
  sendVenue: SendVenueParams
  sendContact: SendContactParams
  sendPoll: SendPollParams
  sendChecklist: SendChecklistParams
  sendDice: SendDiceParams
  sendMessageDraft: SendMessageDraftParams
  ...
  getUserProfileAudios: GetUserProfileAudiosParams
  setUserEmojiStatus: SetUserEmojiStatusParams
  getFile: GetFileParams
  banChatMember: BanChatMemberParams
  unbanChatMember: UnbanChatMemberParams
  restrictChatMember: RestrictChatMemberParams
  promoteChatMember: PromoteChatMemberParams
  setChatAdministratorCustomTitle: SetChatAdministratorCustomTitleParams
  setChatMemberTag: SetChatMemberTagParams
  banChatSenderChat: BanChatSenderChatParams
  unbanChatSenderChat: UnbanChatSenderChatParams
  setChatPermissions: SetChatPermissionsParams
  exportChatInviteLink: ExportChatInviteLinkParams
  createChatInviteLink: CreateChatInviteLinkParams
  editChatInviteLink: EditChatInviteLinkParams
  createChatSubscriptionInviteLink: CreateChatSubscriptionInviteLinkParams
  editChatSubscriptionInviteLink: EditChatSubscriptionInviteLinkParams
  revokeChatInviteLink: RevokeChatInviteLinkParams
  approveChatJoinRequest: ApproveChatJoinRequestParams
  declineChatJoinRequest: DeclineChatJoinRequestParams
  setChatPhoto: SetChatPhotoParams
  deleteChatPhoto: DeleteChatPhotoParams
  setChatTitle: SetChatTitleParams
  setChatDescription: SetChatDescriptionParams
  pinChatMessage: PinChatMessageParams
  unpinChatMessage: UnpinChatMessageParams
  unpinAllChatMessages: UnpinAllChatMessagesParams
  leaveChat: LeaveChatParams
  getChat: GetChatParams
  getChatAdministrators: GetChatAdministratorsParams
  getChatMemberCount: GetChatMemberCountParams
  getChatMember: GetChatMemberParams
  getUserPersonalChatMessages: GetUserPersonalChatMessagesParams
  setChatStickerSet: SetChatStickerSetParams
  deleteChatStickerSet: DeleteChatStickerSetParams
  getForumTopicIconStickers: GetForumTopicIconStickersParams
  createForumTopic: CreateForumTopicParams
  editForumTopic: EditForumTopicParams
  closeForumTopic: CloseForumTopicParams
  reopenForumTopic: ReopenForumTopicParams
  deleteForumTopic: DeleteForumTopicParams
  unpinAllForumTopicMessages: UnpinAllForumTopicMessagesParams
  editGeneralForumTopic: EditGeneralForumTopicParams
  closeGeneralForumTopic: CloseGeneralForumTopicParams
  reopenGeneralForumTopic: ReopenGeneralForumTopicParams
  hideGeneralForumTopic: HideGeneralForumTopicParams
  unhideGeneralForumTopic: UnhideGeneralForumTopicParams
  unpinAllGeneralForumTopicMessages: UnpinAllGeneralForumTopicMessagesParams
  answerCallbackQuery: AnswerCallbackQueryParams
  answerGuestQuery: AnswerGuestQueryParams
  getUserChatBoosts: GetUserChatBoostsParams
  getBusinessConnection: GetBusinessConnectionParams
  getManagedBotToken: GetManagedBotTokenParams
  replaceManagedBotToken: ReplaceManagedBotTokenParams
  getManagedBotAccessSettings: GetManagedBotAccessSettingsParams
  setManagedBotAccessSettings: SetManagedBotAccessSettingsParams
  setMyCommands: SetMyCommandsParams
  deleteMyCommands: DeleteMyCommandsParams
  getMyCommands: GetMyCommandsParams
  setMyName: SetMyNameParams
  getMyName: GetMyNameParams
  setMyDescription: SetMyDescriptionParams
  getMyDescription: GetMyDescriptionParams
  setMyShortDescription: SetMyShortDescriptionParams
  getMyShortDescription: GetMyShortDescriptionParams
  setMyProfilePhoto: SetMyProfilePhotoParams
  removeMyProfilePhoto: RemoveMyProfilePhotoParams
  setChatMenuButton: SetChatMenuButtonParams
  getChatMenuButton: GetChatMenuButtonParams
  setMyDefaultAdministratorRights: SetMyDefaultAdministratorRightsParams
  getMyDefaultAdministratorRights: GetMyDefaultAdministratorRightsParams
  getAvailableGifts: GetAvailableGiftsParams
  sendGift: SendGiftParams
  giftPremiumSubscription: GiftPremiumSubscriptionParams
  verifyUser: VerifyUserParams
  verifyChat: VerifyChatParams
  removeUserVerification: RemoveUserVerificationParams
  removeChatVerification: RemoveChatVerificationParams
  readBusinessMessage: ReadBusinessMessageParams
  deleteBusinessMessages: DeleteBusinessMessagesParams
  setBusinessAccountName: SetBusinessAccountNameParams
  setBusinessAccountUsername: SetBusinessAccountUsernameParams
  setBusinessAccountBio: SetBusinessAccountBioParams
  setBusinessAccountProfilePhoto: SetBusinessAccountProfilePhotoParams
  removeBusinessAccountProfilePhoto: RemoveBusinessAccountProfilePhotoParams
  setBusinessAccountGiftSettings: SetBusinessAccountGiftSettingsParams
  getBusinessAccountStarBalance: GetBusinessAccountStarBalanceParams
  transferBusinessAccountStars: TransferBusinessAccountStarsParams
  getBusinessAccountGifts: GetBusinessAccountGiftsParams
  getUserGifts: GetUserGiftsParams
  getChatGifts: GetChatGiftsParams
  convertGiftToStars: ConvertGiftToStarsParams
  upgradeGift: UpgradeGiftParams
  transferGift: TransferGiftParams
  postStory: PostStoryParams
  repostStory: RepostStoryParams
  editStory: EditStoryParams
  deleteStory: DeleteStoryParams
  answerWebAppQuery: AnswerWebAppQueryParams
  savePreparedInlineMessage: SavePreparedInlineMessageParams
  savePreparedKeyboardButton: SavePreparedKeyboardButtonParams
  editMessageText: EditMessageTextParams
  editMessageCaption: EditMessageCaptionParams
  editMessageMedia: EditMessageMediaParams
  editMessageLiveLocation: EditMessageLiveLocationParams
  stopMessageLiveLocation: StopMessageLiveLocationParams
  editMessageChecklist: EditMessageChecklistParams
  editMessageReplyMarkup: EditMessageReplyMarkupParams
  stopPoll: StopPollParams
  approveSuggestedPost: ApproveSuggestedPostParams
  declineSuggestedPost: DeclineSuggestedPostParams
  deleteMessage: DeleteMessageParams
  deleteMessages: DeleteMessagesParams
  deleteMessageReaction: DeleteMessageReactionParams
  deleteAllMessageReactions: DeleteAllMessageReactionsParams
  sendSticker: SendStickerParams
  getStickerSet: GetStickerSetParams
  getCustomEmojiStickers: GetCustomEmojiStickersParams
  uploadStickerFile: UploadStickerFileParams
  createNewStickerSet: CreateNewStickerSetParams
  addStickerToSet: AddStickerToSetParams
  setStickerPositionInSet: SetStickerPositionInSetParams
  deleteStickerFromSet: DeleteStickerFromSetParams
  replaceStickerInSet: ReplaceStickerInSetParams
  setStickerEmojiList: SetStickerEmojiListParams
  setStickerKeywords: SetStickerKeywordsParams
  setStickerMaskPosition: SetStickerMaskPositionParams
  setStickerSetTitle: SetStickerSetTitleParams
  setStickerSetThumbnail: SetStickerSetThumbnailParams
  setCustomEmojiStickerSetThumbnail: SetCustomEmojiStickerSetThumbnailParams
  deleteStickerSet: DeleteStickerSetParams
  answerInlineQuery: AnswerInlineQueryParams
  sendInvoice: SendInvoiceParams
  createInvoiceLink: CreateInvoiceLinkParams
  answerShippingQuery: AnswerShippingQueryParams
  answerPreCheckoutQuery: AnswerPreCheckoutQueryParams
  getMyStarBalance: GetMyStarBalanceParams
  getStarTransactions: GetStarTransactionsParams
  refundStarPayment: RefundStarPaymentParams
  editUserStarSubscription: EditUserStarSubscriptionParams
  setPassportDataErrors: SetPassportDataErrorsParams
  sendGame: SendGameParams
  setGameScore: SetGameScoreParams
  getGameHighScores: GetGameHighScoresParams
}

export type BotApiMethodName = keyof BotApiMethods
