 ...
 *
 * @see {@link DefaultLunaConfig} for keys to override
 * @example
 * ```ts
 * // global.d.ts
 ...
 */
export interface LunaConfig {}
export type LunaConfigFor<Key extends keyof DefaultLunaConfig> = Key extends keyof LunaConfig
  ? LunaConfig[Key]
  : DefaultLunaConfig[Key]
export type ErrorValue = LunaConfigFor<'errorValueType'>
export type FlashData = LunaConfigFor<'flashDataType'>
export type SharedPageProps = LunaConfigFor<'sharedPageProps'>
export type LayoutProps = LunaConfigFor<'layoutProps'>
export type NamedLayoutProps = LunaConfigFor<'namedLayoutProps'>
...
interface BaseCreateLunaAppOptions<TComponentResolver, TSetupOptions, TSetupReturn, TAdditionalLunaAppConfig> {
  ...
  nonce?: string
  defaults?: FirstLevelOptional<LunaAppConfig & TAdditionalLunaAppConfig>
...
export interface CreateLunaAppOptionsForCSR<
  SharedProps extends PageProps,
  TComponentResolver,
  TSetupOptions,
  TSetupReturn,
  TAdditionalLunaAppConfig,
> extends BaseCreateLunaAppOptions<TComponentResolver, TSetupOptions, TSetupReturn, TAdditionalLunaAppConfig> {
  id?: string
...
export interface CreateLunaAppOptionsForSSR<
  SharedProps extends PageProps,
  TComponentResolver,
  TSetupOptions,
  TSetupReturn,
...
export type LunaAppSSRResponse = { head: string[]; body: string }
export type LunaAppResponse = Promise<LunaAppSSRResponse | void>
...
export interface CreateLunaAppOptions<TComponentResolver, TSetupOptions, TSetupReturn, TAdditionalLunaAppConfig> {
  id?: string
  resolve?: TComponentResolver
  pages?: PagesOption
  layout?: (name: string, page: Page) => unknown
...
type UseFormLunaArguments<TForm> =
  | []
  | [data: TForm | (() => TForm)]
...
export type UseFormArguments<TForm> = UseFormLunaArguments<TForm> | UseFormPrecognitionArguments<TForm>
...
declare global {
  interface DocumentEventMap {
    'luna:before': GlobalEvent<'before'>
    'luna:start': GlobalEvent<'start'>
    'luna:progress': GlobalEvent<'progress'>
    'luna:success': GlobalEvent<'success'>
    'luna:error': GlobalEvent<'error'>
    'luna:httpException': GlobalEvent<'httpException'>
    'luna:networkError': GlobalEvent<'networkError'>
    'luna:finish': GlobalEvent<'finish'>
    'luna:beforeUpdate': GlobalEvent<'beforeUpdate'>
    'luna:navigate': GlobalEvent<'navigate'>
    'luna:clientVisit': GlobalEvent<'clientVisit'>
    'luna:flash': GlobalEvent<'flash'>
    'luna:location': GlobalEvent<'location'>
  }
}
