...
interface BaseLunaLinkProps extends LinkComponentBaseProps {
  as?: ElementType
  onClick?: (event: React.MouseEvent) => void
}

export type LunaLinkProps = BaseLunaLinkProps &
  Omit<React.HTMLAttributes<HTMLElement>, keyof BaseLunaLinkProps> &
  Omit<React.AllHTMLAttributes<HTMLElement>, keyof BaseLunaLinkProps>

const Link = forwardRef<unknown, LunaLinkProps>(
  (
    {
      children,
      as = 'a',
