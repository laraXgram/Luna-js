 ...
 *
 * Handles three cases:
 * 1. Empty call:    `createLunaApp()`    becomes `createLunaApp({ resolve: ... })`
 * 2. Empty object:  `createLunaApp({})`  becomes `createLunaApp({ resolve: ... })`
 * 3. Other options: `createLunaApp({a})` becomes `createLunaApp({ resolve: ..., a})`
 */
