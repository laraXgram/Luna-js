...
export interface LunaLinkProps extends LinkComponentBaseProps {
  as?: string | Component
  onClick?: (event: MouseEvent) => void
}

type LunaLink = DefineComponent<LunaLinkProps>

const Link: LunaLink = defineComponent({
  name: 'Link',
  props: {
    as: {
      type: [String, Object] as PropType<LunaLinkProps['as']>,
      default: 'a',
    },
    data: {
      type: Object as PropType<LunaLinkProps['data']>,
      default: () => ({}),
    },
    href: {
      type: [String, Object] as PropType<LunaLinkProps['href']>,
      default: '',
    },
    method: {
      type: String as PropType<LunaLinkProps['method']>,
      default: 'get',
    },
    replace: {
      type: Boolean as PropType<LunaLinkProps['replace']>,
      default: false,
    },
    preserveScroll: {
      type: [Boolean, String, Function] as PropType<LunaLinkProps['preserveScroll']>,
      default: false,
    },
    preserveState: {
      type: [Boolean, String, Function] as PropType<LunaLinkProps['preserveState']>,
      default: null,
    },
    preserveUrl: {
      type: Boolean as PropType<LunaLinkProps['preserveUrl']>,
      default: false,
    },
    only: {
      type: Array as PropType<LunaLinkProps['only']>,
      default: () => [],
    },
    except: {
      type: Array as PropType<LunaLinkProps['except']>,
      default: () => [],
    },
    headers: {
      type: Object as PropType<LunaLinkProps['headers']>,
      default: () => ({}),
    },
    queryStringArrayFormat: {
      type: String as PropType<LunaLinkProps['queryStringArrayFormat']>,
      default: 'brackets',
    },
    async: {
      type: Boolean as PropType<LunaLinkProps['async']>,
      default: false,
    },
    prefetch: {
      type: [Boolean, String, Array] as PropType<LunaLinkProps['prefetch']>,
      default: false,
    },
    cacheFor: {
      type: [Number, String, Array] as PropType<LunaLinkProps['cacheFor']>,
      default: 0,
    },
    onStart: {
      type: Function as PropType<LunaLinkProps['onStart']>,
      default: noop,
    },
    onProgress: {
      type: Function as PropType<LunaLinkProps['onProgress']>,
      default: noop,
    },
    onFinish: {
      type: Function as PropType<LunaLinkProps['onFinish']>,
      default: noop,
    },
    onBefore: {
      type: Function as PropType<LunaLinkProps['onBefore']>,
      default: noop,
    },
    onCancel: {
      type: Function as PropType<LunaLinkProps['onCancel']>,
      default: noop,
    },
    onSuccess: {
      type: Function as PropType<LunaLinkProps['onSuccess']>,
      default: noop,
    },
    onError: {
      type: Function as PropType<LunaLinkProps['onError']>,
      default: noop,
    },
    onCancelToken: {
      type: Function as PropType<LunaLinkProps['onCancelToken']>,
      default: noop,
    },
    onPrefetching: {
      type: Function as PropType<LunaLinkProps['onPrefetching']>,
      default: noop,
    },
    onPrefetched: {
      type: Function as PropType<LunaLinkProps['onPrefetched']>,
      default: noop,
    },
    cacheTags: {
      type: [String, Array] as PropType<LunaLinkProps['cacheTags']>,
      default: () => [],
    },
    viewTransition: {
      type: [Boolean, Object] as PropType<LunaLinkProps['viewTransition']>,
      default: false,
    },
    component: {
      type: String as PropType<LunaLinkProps['component']>,
      default: null,
    },
    instant: {
      type: Boolean as PropType<LunaLinkProps['instant']>,
      default: false,
    },
    pageProps: {
      type: [Object, Function] as PropType<LunaLinkProps['pageProps']>,
      default: null,
    },
  },
