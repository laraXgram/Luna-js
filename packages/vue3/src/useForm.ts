...
export interface LunaFormProps<TForm extends object> {
  ...
  withPrecognition(...args: UseFormWithPrecognitionArguments): LunaPrecognitiveForm<TForm>
}
...
export type LunaForm<TForm extends object> = TForm & LunaFormProps<TForm>
export type LunaPrecognitiveForm<TForm extends object> = LunaForm<TForm> &
...
export default function useForm<TForm extends FormDataType<TForm>>(): LunaForm<TForm>
export default function useForm<TForm extends FormDataType<TForm>>(
  ...args: UseFormArguments<TForm>
): LunaForm<TForm> | LunaPrecognitiveForm<TForm> {
  ...
  const form = baseForm as unknown as LunaForm<TForm>
  ...
  return getPrecognitionEndpoint() ? (form as LunaPrecognitiveForm<TForm>) : form
}
