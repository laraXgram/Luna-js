...
<div>
  ...
  <div style="width: 200vw; height: 200vh; margin-top: 50vh">
    ...
    <a href="/links/url-fragments#target" use:luna class="basic">Basic link</a>
    <a href="#target" use:luna class="fragment">Fragment link</a>
    <a href="/links/url-fragments#non-existent-fragment" use:luna class="non-existent-fragment"
