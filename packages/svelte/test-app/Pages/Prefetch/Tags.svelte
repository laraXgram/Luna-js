...
<div>
  <div id="links">
    <a href="/prefetch/tags/1" use:luna={{ prefetch: 'hover', cacheTags: ['user', 'profile'] }}> User Page 1 </a>
    <a href="/prefetch/tags/2" use:luna={{ prefetch: 'hover', cacheTags: ['user', 'settings'] }}> User Page 2 </a>
    <a href="/prefetch/tags/3" use:luna={{ prefetch: 'hover', cacheTags: ['product', 'catalog'] }}>
      Product Page 3
    </a>
    <a href="/prefetch/tags/4" use:luna={{ prefetch: 'hover', cacheTags: ['product', 'details'] }}>
      Product Page 4
    </a>
    <a
      href="/prefetch/tags/5"
      use:luna={{ prefetch: 'hover', cacheTags: propType === 'string' ? 'admin' : ['admin'] }}
    >
      Admin Page 5
    </a>
    <a href="/prefetch/tags/6" use:luna={{ prefetch: 'hover' }}> Untagged Page 6 </a>
  </div>
  <div id="controls">
