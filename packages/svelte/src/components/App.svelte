...
<script lang="ts">
  ...
  interface Props {
    initialComponent: LunaAppProps['initialComponent']
    initialPage: LunaAppProps['initialPage']
    resolveComponent: LunaAppProps['resolveComponent']
    defaultLayout?: LunaAppProps['defaultLayout']
  }
